...
I18N = merge_i18n({
  ...
  'en': {
    ...
    "en.visual.p1": "ADPETROS develops solutions to recover and add value to associated gas that would otherwise be flared or vented during operations.",
    "en.visual.sub": "Where recovered gas can be put to work:",
    ...
    "en.visual.p2": "Turning that gas into one of these outcomes creates value from a resource that was previously wasted, while directly reducing the emissions associated with flaring.",
    ...
    "en.ex.eyebrow": "PRACTICAL EXAMPLE", "en.ex.title": "Imagine the following situation:",
    "en.ex.p": "There's gas being flared in an operation, and no one has precisely quantified how much value is being lost. We help precisely measure that latent potential, turning a costly environmental waste stream into a steady revenue source.",
